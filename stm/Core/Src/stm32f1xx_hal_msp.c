...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART5_MspInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    GPIO_InitStruct.Pin = UPPER_SERVO_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(UPPER_SERVO_TX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = UPPER_SERVO_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(UPPER_SERVO_RX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(UPPER_SERVO_TX_GPIO_Port, UPPER_SERVO_TX_Pin);

    HAL_GPIO_DeInit(UPPER_SERVO_RX_GPIO_Port, UPPER_SERVO_RX_Pin);
